      ...
      <div className="grid grid-cols-1 lg:grid-cols-2  ">
        ...
        <div className="isolate bg-white px-6 py-24 sm:py-10 lg:px-7 p-7 ">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-lg leading-8 text-gray-60 p-5">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odit
              laudantium similique, repellendus assumenda eveniet nulla
              voluptates provident, nam adipisci debitis ratione qui ad mollitia
              cumque harum nesciunt? Expedita, inventore commodi.
            </p>
          </div>
          <form
            action="#"
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative mt-2.5">
                  <div className="absolute inset-y-0 left-0 flex items-center">
                    ...
                    >
                      <option className="font-medium">+92 |</option>
                    </select>
                    <ChevronDownIcon
